from .spectrum import FrequencyDirectionSpectrum, FrequencySpectrum
...
def create_parametric_frequency_direction_spectrum(
    ...
    **kwargs,
    ...
    if time is None:
        time = numpy.datetime64().astype('<M8[ns]')
    else:
    ...
    dataset = Dataset(
        ...
        coords = {NAME_F:frequency_hertz, NAME_D:direction_degrees,NAME_LAT:latitude,NAME_LON:longitude,NAME_T:time},
    )
